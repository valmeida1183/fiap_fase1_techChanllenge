...
namespace IntegrationTest.Service
{
    public class ContactServiceTests : IDisposable
    {
        ...
        public ContactServiceTests()
        {
            ...
            // Initialize service
            _contactService = new ContactService(contactRepository, dddRepository);
        ...
        {
            // Act & Assert
            var exception = await Assert.ThrowsAsync<ArgumentException>(() => _contactService.GetAllByDddAsync(999));
